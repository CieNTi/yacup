/* test_cp_B416K.c - Test to check cp's cp_simple functionality
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
#undef YCP_NAME
#define YCP_NAME "util/cp/test/test_cp_B416K"
#include <time.h>
#include <stdio.h>
#include <string.h>
#ifndef _dbg
 ...
 * @version    v1.0.0
 */
int test_cp_B416K(int argc, const char* argv[])
{
  /* Testbench vars */
  ...
  if (cp_setup(&cp_B416K0, buffer, TEST_CP_TESTNAME_BUFFER_SIZE))
  {
