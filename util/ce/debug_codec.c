/* debug_codec.c - Debug functions to ease `ce_codec` development flow
...
#undef YCP_NAME
#define YCP_NAME "util/ce/debug_codec"

/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* Print `ce_codec` information to STDOUT.
 * Read `yacup/ce/debug_codec.h` for complete information. */
